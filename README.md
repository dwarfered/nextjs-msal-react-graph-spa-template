...
A production-ready Next.js 16 App Router template for building secure single-page applications with Microsoft Entra ID authentication (MSAL React) and Microsoft Graph.
